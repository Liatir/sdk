...
const OPENMM_MACOS_AARCH64_CPU_DEVELOPMENT_PROFILE: LiatirHardwareValidationProfile = {
  schemaVersion: 1,
  profileId: "openmm-8.5.1-beta.1-macos-aarch64-cpu-development-2026-09-06",
  ...
  precision: "mixed",
  measuredAt: "2026-09-06T12:23:08.255Z",
  evidenceRecord: "runtime-boxes/measurements/openmm-macos-aarch64-cpu-development-2026-09-06.json",
  samples: [
    {
