...
const OPENMM_MACOS_AARCH64_CPU_DEVELOPMENT_PROFILE: LiatirHardwareValidationProfile = {
  schemaVersion: 1,
  profileId: "openmm-8.5.1-beta.1-macos-aarch64-cpu-development-2026-09-08",
  ...
  precision: "mixed",
  measuredAt: "2026-09-08T14:14:11.029Z",
  evidenceRecord: "runtime-boxes/measurements/openmm-macos-aarch64-cpu-development-2026-09-08.json",
  samples: [
    {
    ...
    },
    {
      ...
      maxStepCount: 5000,
      maxOutputItemCount: 10,
      peakRamBytes: 346718208,
      peakVramBytes: null,
      elapsedMs: 197062,
      outputBytes: 31317251,
    },
    {
