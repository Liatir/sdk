...
export type LiatirStepKind = "native-tool" | "lia-plugin" | "wasm-plugin" | "api-request" | "ai-tool" | "utility" | "sub-pipeline";
...
export type LiatirFileArtifactRole = "final" | "intermediate" | "cache" | "temp";
export type LiatirArtifactProducerKind = LiatirStepKind | "pipeline" | "ai-model" | "dependency" | "system" | "unknown";
...
export type LiatirArtifactParentRunKind = "tool" | "pipeline" | "pipeline-step" | "ai-model-direct" | "dependency" | "unknown";
...
export type LiatirToolSection = LiatirStatsSection | LiatirNumberSection | LiatirPlotlySection | LiatirTextSection | LiatirTableSection | LiatirStructureViewerSection | LiatirGenomeViewerSection | LiatirSingleCellViewerSection;
...
export type LiatirAICapability = "text-generation" | "summarization" | "classification" | "cell-annotation" | "single-cell-embedding" | "batch-correction" | "perturbation-prediction" | "gene-network-inference" | "embedding" | "sequence-embedding" | "regulatory-prediction" | "variant-effect-scoring" | "protein-structure-prediction" | "protein-binding" | "reranking" | "structured-extraction";
