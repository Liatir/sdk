...
const UCE_PYTHON_3_10_TO_3_11 = {
    ...
    maxVersionExclusive: '3.12',
    label: 'Python 3.10 or 3.11',
    reason: 'UCE official requirements pin torch 2.1.1 and scanpy 1.10.2; Liatir validates this runtime on Python 3.10/3.11.'
};
const INTERNAL_AI_MODEL_REGISTRY = [
    {
        id: MOCK_AI_MODEL_ID,
...
export const BUILT_IN_AI_MODEL_REGISTRY = [
    {
    ...
    },
    {
        ...
        documentation: {
            ...
            officialUrl: 'https://huggingface.co/InstaDeepAI/nucleotide-transformer-v2-50m-multi-species'
        },
    ...
    },
    {
        ...
        description: 'Larger managed local DNA/RNA foundation model for genomic embeddings and embedding-delta variant effect scoring.',
        category: 'Genomics',
        ...
        hardware: {
            ...
            notes: 'Larger Nucleotide Transformer checkpoint. CPU can work for short windows, but GPU/MPS is strongly preferred for repeated variant scoring.'
        },
        install: {
            method: 'managed-runtime',
            runtimeId: 'sequence-transformers',
        ...
        documentation: {
            ...
            officialUrl: 'https://huggingface.co/InstaDeepAI/nucleotide-transformer-v2-500m-multi-species'
        },
    ...
    },
    {
        ...
        description: 'Managed local Enformer runtime for long-range regulatory activity prediction and variant-effect scoring from genomic sequence windows.',
        ...
        hardware: {
            ...
            minVramGb: 0,
            recommendedVramGb: 16,
            notes: 'Long input windows make CPU inference slow. GPU acceleration depends on the local TensorFlow backend.'
        },
        install: {
            method: 'managed-runtime',
    ...
    },
    {
        ...
        description: 'Managed local Basenji2 human regulatory model for sequence activity prediction and focused variant-effect scoring.',
        category: 'Predictive Genomics',
        ...
        hardware: {
            ...
            notes: 'CPU inference is supported for small tests, but repeated windows are much faster on a TensorFlow GPU backend.'
        },
        install: {
            method: 'managed-runtime',
    ...
    },
    {
        ...
        description: 'Managed local Mini Borzoi K562 RNA-seq model for RNA-seq signal prediction from genomic sequence windows.',
        category: 'Predictive Genomics',
        ...
        hardware: {
            ...
            minVramGb: 0,
            recommendedVramGb: 16,
            notes: 'Borzoi uses very long sequence windows. CPU works for small validation runs, but GPU is strongly preferred.'
        },
        install: {
            method: 'managed-runtime',
            ...
            hostRequirements: {
                python: {
                    ...
                    label: 'Python 3.10',
                    reason: 'The official Borzoi documentation recommends Python 3.10 with TensorFlow 2.15.x.'
                }
            }
        },
        documentation: {
    ...
    },
    {
        ...
        description: 'Preview single-cell foundation model for cell embeddings, integration, perturbation hypotheses, and gene-network exploration.',
        ...
        hardware: {
            ...
            minVramGb: 0,
            recommendedVramGb: 16,
            notes: 'CPU can load small examples, but meaningful foundation-model embedding and perturbation workflows should use a GPU.'
        },
        documentation: {
    ...
    },
    {
        ...
        description: 'Preview human single-cell transcriptome foundation model for embeddings, gene-network insight, and in-silico perturbation workflows.',
        category: 'Single-cell Foundation Models',
        version: 'v1-10m',
        releaseStage: 'preview',
        runtime: {
        ...
        hardware: {
            ...
            minVramGb: 0,
            recommendedVramGb: 16,
            notes: 'GPU resources are strongly recommended by the official documentation for efficient use.'
        },
        documentation: {
    ...
    },
    {
        ...
        name: 'UCE 4-layer',
        description: 'Managed zero-shot Universal Cell Embeddings runtime for AnnData single-cell expression embeddings.',
        category: 'Single-cell Foundation Models',
        version: '4-layer',
        runtime: {
            kind: 'python-venv',
        ...
        hardware: {
            ...
            minVramGb: 0,
            recommendedVramGb: 16,
            notes: 'GPU is recommended by the model card. CPU can be used for small validation datasets, but repeated runs should use a GPU-capable workstation.'
        },
        install: {
            method: 'managed-runtime',
    ...
    },
    {
        ...
        description: 'Preview large-scale single-cell foundation model candidate for embeddings and downstream cell-state analysis.',
        category: 'Single-cell Foundation Models',
        version: '100m',
        releaseStage: 'preview',
        runtime: {
        ...
        hardware: {
            ...
            notes: 'Large model candidate. Liatir should keep it behind a dedicated runtime and managed checkpoint box before exposing install.'
        },
        documentation: {
    ...
    },
    {
        ...
        catalogHiddenReason: 'Deferred until Liatir can validate the Linux CUDA runtime on supported hardware.',
        version: '0.6.1',
        runtime: {
            kind: 'python-venv',
...
export const LOCAL_AI_MODEL_REGISTRY = [
    ...BUILT_IN_AI_MODEL_REGISTRY,
    ...INTERNAL_AI_MODEL_REGISTRY
];
export function isAIModelCatalogVisible(model) {
    return model.catalogVisibility !== 'hidden';
}
export const VISIBLE_LOCAL_AI_MODEL_REGISTRY = LOCAL_AI_MODEL_REGISTRY.filter(isAIModelCatalogVisible);
export function getLocalAIModelMetadata(id) {
...
export function runtimePackagesForModel(model) {
    return model.install?.runtimePackages ?? [];
}
export function runtimeSourcesForModel(model) {
    return model.install?.runtimeSources ?? [];
}
export function packageChecksForModel(model) {
